...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ControlToValidate="dropDownProductType" ForeColor="Red"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td style="height: 100px;">
                <asp:Button ID="btnUpdate" runat="server" Text="UPDATE" OnClick="btnUpdate_Click" TabIndex="7" Height="35px" Width="100px"  />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnReset" runat="server" Text="RESET" TabIndex="8" CausesValidation="false" Height="35px" Width="100px" OnClick="btnReset_Click" />
            </td>
        </tr>
    </table>
    </div>
